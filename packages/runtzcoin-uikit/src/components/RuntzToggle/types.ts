...
export interface RuntzToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  ...
  runtzThickness: "runtzThickness",
  runtzTwoOffset: "runtzTwoOffset",
  runtzThreeOffset: "runtzThreeOffset",
  butterTop: "butterTop",
