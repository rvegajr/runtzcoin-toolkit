...
Current version of this SDK is 90% copy of existing from [runtz-frontend](https://github.com/rvegajr/runtz-frontend) repo. There are several improvements to be made in the future versions of this SDK:
