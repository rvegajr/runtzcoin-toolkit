...
class RuntzProfileSdk {
   ...
   * API repo - https://github.com/runtzswap/runtz-profile-api
   */
   ...
   * Contract repo - https://github.com/runtzswap/runtz-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from RuntzProfile contract.
   * NFT's bunnyId is retrieved from RuntzBunnies contract and mapped to static NFT data stored in constant.
   * Contracts repo - https://github.com/runtzswap/runtz-contracts/tree/master/projects/profile-nft-gamification
   */
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://runtzswap.finance/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "runtzswap.finance", secure: true, expires: 30 }
        );
      }
...
export default RuntzProfileSdk;
