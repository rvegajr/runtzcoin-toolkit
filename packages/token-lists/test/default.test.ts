...
import currentRuntzswapDefaultList from "../lists/pancakeswap-default.json";
import currentRuntzswapExtendedtList from "../lists/pancakeswap-extended.json";
import currentRuntzswapTop15List from "../lists/pancakeswap-top-15.json";
import currentRuntzswapTop100tList from "../lists/pancakeswap-top-100.json";
import { buildList, VersionBump } from "../src/buildList";

const currentLists = {
  "pancakeswap-default": currentRuntzswapDefaultList,
  "pancakeswap-extended": currentRuntzswapExtendedtList,
  "pancakeswap-top-100": currentRuntzswapTop100tList,
  "pancakeswap-top-15": currentRuntzswapTop15List,
};
